...
import { Icon, Icons } from '@/components/Items'
                                ...
                                return (
                                    <li key={option.id}>
                                        <Link href={option.href} className='text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group flex gap-3 rounded-md p-2 text-sm leading-6 font-semibold'>
                                            <span className='text-gray-400 border-gray-200 group-hover:border-indigo-600 group-hover:text-indigo-600 flex h-6 w-6 shrink-0 items-center justify-content rounded-lg border text-[0.625rem] font-medium bg-white'>
                    ...
                    <li className='-mx-6 mt-auto flex items-center'>
                        <div className='flex flex-1 items-center gap-x-2 px-3 py-3 text-sm font-semibold leading-6 text-gray-900'>
                            ...
                            <div className='flex flex-col'>
                                ...
                                <span className='text-xs text-zinc-400 truncate w-52' aria-hidden="true">{session.user.email}</span>
                            </div>
                        </div>

                        <SignOutButton className='h-18 aspect-square' />
                    </li>
                </ul>
            </nav>
